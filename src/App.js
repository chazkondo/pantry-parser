...
const App = () => {
  ...
  return (
    <div className="bg-gray-100 p-4 min-h-screen">
      <a href="https://github.com/chazkondo/pantry-parser">
        <h1 style={{display: 'inline-block'}} title="Instructions" className="text-2xl font-bold mb-4 hover">List Household Food Items</h1>
      </a>
